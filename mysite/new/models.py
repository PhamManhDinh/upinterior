...
class NewIndexPage(Page):
    ...
    def get_context(self, request):
        ...
        url_about_index = AboutIndexPage.objects.live()[0]
        # Sử dụng Paginator với 12 bài post mỗi trang
        paginator = Paginator(blogpages, 15)
        ...
        context['url_about_index'] = url_about_index
        return context
...
class NewPage(Page):
    ...
    def get_context(self, request):
        ...
        recent_posts = NewPage.objects.live().order_by('-first_published_at')[:10]
